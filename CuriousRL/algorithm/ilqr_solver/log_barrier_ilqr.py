...
class LogBarrieriLQR(iLQRWrapper):
    ...
    def init(self, scenario: DynamicModelWrapper, is_use_logger = True, logger_folder = None, is_save_json = True):
        ...
        if scenario.get_add_param() is None:
            ...
            add_param = np.hstack([scenario.get_add_param(), self.t[0]*np.ones((self.T, 1))])
    ...
    def solve(self):
        ...
        for j in self.t:
            ...
            for i in range(self.max_iter):
                ...
                obj = self.real_obj_fun.eval_obj_fun(self.get_traj()) # do not care the value of log barrier
