...
class ThreeLinkPlanarManipulator(DynamicModelWrapper):
    ...
    def render(self):
        ...
        if self._fig is None:
            super().create_plot(xlim=(-6,6), ylim=(-6,6))
    ...
    def action_space(self):
        ...
        return ActionSpace(action_range=[[-100, 100], [-100, 100], [-100, 100]], action_type=["Continuous", "Continuous", "Continuous"], action_info=["Moment 1", "Moment 2", "Moment 3"])